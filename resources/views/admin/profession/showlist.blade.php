...
<body>
    ...
    <div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="profession_add('添加专业','addprofess','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加专业</a></div>
            ...
            <tbody>
               @foreach ($data as $val)
                <tr class="text-c">
                    ...
                    <td>{{$val->rea_protype -> protype_name}}</td>
