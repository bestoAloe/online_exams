...
<![endif]-->
<title>添加试卷</title>
<meta name="keywords" content="添加试卷">
<meta name="description" content="添加试卷">
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="testpaper_name" name="testpaper_name">
		</div>
	</div>
	<div class="row cl">
