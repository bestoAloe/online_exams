...
<![endif]-->
<title>添加点播</title>
<meta name="keywords" content="添加点播">
<meta name="description" content="添加点播">
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="video_time" id="video_time">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">描述（可选）：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="description" id="description">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>视频状态：</label>
...
<script type="text/javascript" src="/public/statics/videoload.js"></script>
...
$('select[name=profession_id]').change(function(){
  ...
  $.get('./admgetprofession_id',{profession_id:profession_id},function(prof){
    //jquery的循环操作
    let str = '';
    $.each(prof,function(index,el){
