...
<body>
    ...
    <div class="page-container">
        ...
        <a href="javascript:;" onclick="stu_add('添加学生','add_stu','','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加学生</a></span></div>
               ...
               @foreach ($data as $val)
                <tr class="text-c">
                    ...
                    <td class="td-manage">
                        ...
                        @endif
                        <a title="编辑" href="javascript:;" onclick="admin_edit('学生编辑','admin-add.html','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                        {{csrf_field()}}
