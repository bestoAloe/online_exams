...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>课程归属：</label>
		...
		<div class="row cl">
            ...
            <div id="uploader-demo">
                ...
                <div id="fileList" class="uploader-list">
                  <!--隐藏域-->
                   <input type="hidden" name="excelpath" id="excelpath1" value="">
                </div>
                <div id="filePicker">选择封面</div>
            </div>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>课程状态：</label>
...
<script type="text/javascript" src="/public/statics/imageload.js"></script>
